    ...
    <section className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr,280px] gap-6">
        ...
        <aside className="h-fit lg:sticky lg:top-20 bg-white rounded-md border p-4">
          ...
          <NavLink to="/Evaluaciones"> <button className="w-full mt-4 rounded bg-duocamarillo text-duocgris font-bold py-2 hover:bg-duocazul hover:text-white"> Enviar resultados </button> </NavLink>
        </aside>
      </div>
    </section>
  );
