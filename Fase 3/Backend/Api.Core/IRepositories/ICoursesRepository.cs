...
namespace Api.Core.IRepositories
{
    public interface ICoursesRepository
    {
        ...
        Task<List<Lessons>> GetLessonsByCourseIdAsync(long courseId);
        Task<List<Courses>> GetAllWithDetailsAsync();

        Task<bool> IsStudentEnrolledAsync(long courseId, long studentId);
