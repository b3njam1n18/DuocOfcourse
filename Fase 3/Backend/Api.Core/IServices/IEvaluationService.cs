...
namespace Api.Core.IServices
{
    public interface IEvaluationService
    {
        ...
        Task<List<EvaluationFullResponse>> GetEvaluationsByLessonAsync(long courseId, long lessonId, bool? published);

        Task<AttemptResultResponse?> GetLastAttemptByStudentAsync(long evaluationId, long studentId);
