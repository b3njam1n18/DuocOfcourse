...
const handleSubmit = (e) => {
  ...
  // Enviamos UN SOLO objeto con todos los datos
  onSubmit?.({
    nombre: nombre.trim(),
    descripcion: descripcion.trim(),
    relacionada: relacionada.trim(),
    file, // por ahora sólo lo usamos a nivel UI
  });
                ...
                >
                  {!file ? (
                    <div className="text-center select-none">
                      <svg
                        className="mx-auto w-12 h-12 text-gray-500 mb-2"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                      >
                      ...
                      <span className="text-sm text-duocceleste underline">
                        Arrastre o suba imagen
                      </span>
                    </div>
                  ) : (
                    <img
