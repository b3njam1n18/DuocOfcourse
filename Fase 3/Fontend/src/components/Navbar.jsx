  ...
  return (
    <div className="flex flex-col h-full p-4 text-white">
      ...
      <nav className="flex flex-col gap-3">
        <NavLink to="/app" className={({isActive})=>`${baseBtn} ${isActive?activeBtn:inactiveBtn}`} onClick={onClose}>
          Mis cursos
        </NavLink>
        <NavLink to="/app/Explorar" className={({isActive})=>`${baseBtn} ${isActive?activeBtn:inactiveBtn}`} onClick={onClose}>
          Explorar cursos
        </NavLink>
        <NavLink to="/app/Evaluaciones" className={({isActive})=>`${baseBtn} ${isActive?activeBtn:inactiveBtn}`} onClick={onClose}>
          Evaluaciones
        </NavLink>
        <NavLink to="/app/Certificados" className={({isActive})=>`${baseBtn} ${isActive?activeBtn:inactiveBtn}`} onClick={onClose}>
          Certificados
        </NavLink>
        <NavLink to="/app/Calificaciones" className={({isActive})=>`${baseBtn} ${isActive?activeBtn:inactiveBtn}`} onClick={onClose}>
          Calificaciones
        </NavLink>
      </nav>
